...
- [x] Explain what a token is used for.
      Token is used to access protected areas of websites that usually have a login
- [x] What steps can you take in your web apps to keep your data secure?
      Using private and protected routes that require a token
- [x] Describe how web servers work.
      Web servers hold the information for a web page and sends the information to your browser when requested
